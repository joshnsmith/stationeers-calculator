...
const calculators: Calculator[] = [
  ...
  },
  {
    ...
    path: "/tools/base-layout-planner",
    comingSoon: true
  },
  {
  ...
  },
  {
    ...
    path: "/tools/power-grid-calculator",
    comingSoon: true
  }
